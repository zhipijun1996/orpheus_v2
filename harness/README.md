...
Context routing combines target and task-semantic dependencies. Route Engine review separates Shared openness from Route-local commitment, distinguishes Story Engine / Route Truth / Evidence, requires designated core-mystery closure, and tests causal fusion among character relationship, Route-defining speculative premise, and Shared mystery. Fusion is graded rather than forcing one dramatic shape: only DETACHED is a hard failure.
